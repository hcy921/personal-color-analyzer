          ...
          <div className="grid grid-cols-6 gap-2 mb-4">
            {result.colors.map((color, i) => (
              <div key={i} className="flex flex-col items-center gap-1">
                ...
                <p className="text-cream-text" style={{ fontSize: '11px' }}>{color.name}</p>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-6 gap-2 mb-4">
            {result.worstColors.map((worstColors, i) => (
              <div key={i} className="flex flex-col items-center gap-1">
                ...
                <p className="text-cream-text" style={{ fontSize: '11px' }}>{worstColors.name}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          ...
          <div className="bg-white border border-cream-border rounded-3xl p-4">
            ...
            <div className="flex flex-col gap-1">
              {result.lip.map((lip, i) => (
                 <p className="text-cream-text" style={{ fontSize: '11px' }}>{lip.name}</p>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white border border-cream-border rounded-3xl p-4">
            ...
            <div className="flex flex-col gap-1">
              {result.blush.map((blush, i) => (
                <p  key={i} className="text-cream-text" style={{ fontSize: '11px' }}>{blush.name}</p>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white border border-cream-border rounded-3xl p-4">
            ...
            <div className="flex flex-col gap-1">
              {result.hair.map((hair, i) => (
                <p key={i} className="text-cream-text" style={{ fontSize: '11px' }}>{hair.name}</p>
